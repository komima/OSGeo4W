...
scripts\setup-x86_64.exe ^
	...
	-l %TEMP%/cygwin ^
	-P "bison,flex,poppler,doxygen,git,unzip,tar,diffutils,patch,curl,wget,flip,p7zip,make,osslsigncode,mingw64-x86_64-gcc-core,catdoc,enscript,mingw64-x86_64-binutils,perl-Data-UUID,ruby=2.6.4-1,perl-YAML-Tiny" > NUL & :: no output, super verbose
